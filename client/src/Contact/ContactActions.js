...
const DELETE_CONTACT_COMPANY_REQUEST = 'DELETE_CONTACT_COMPANY_REQUEST';
const DELETE_CONTACT_COMPANY_SUCCESS = 'DELETE_CONTACT_COMPANY_SUCCESS';
const DELETE_CONTACT_COMPANY_FAILURE = 'DELETE_CONTACT_COMPANY_FAILURE';
...
export const deleteContactsCompany = (name) => {
  return function (dispatch) {
    dispatch({
      type: DELETE_CONTACT_COMPANY_REQUEST
    })
    fetch(`${API_URL}/deleteContactCompany`, {
      method: 'DELETE',
      headers: {
        'Content-Type': 'application/json'
      },
      ...
      .then(data => {
        dispatch({
          type: DELETE_CONTACT_COMPANY_SUCCESS,
          name: name
        })
      })
      .catch(error => {
        dispatch({
          type: DELETE_CONTACT_COMPANY_FAILURE,
          error: error
        })
      })
  }
